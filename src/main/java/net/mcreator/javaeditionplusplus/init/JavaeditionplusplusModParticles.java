...
import net.mcreator.javaeditionplusplus.client.particle.LeaveParticle;
...
public class JavaeditionplusplusModParticles {
	private static final Map<ParticleType<?>, Function<SpriteSet, ParticleProvider<SimpleParticleType>>> REGISTRY = new HashMap<>();
	public static final SimpleParticleType LEAVE = register(new SimpleParticleType(false).setRegistryName("leave"), LeaveParticle::provider);
