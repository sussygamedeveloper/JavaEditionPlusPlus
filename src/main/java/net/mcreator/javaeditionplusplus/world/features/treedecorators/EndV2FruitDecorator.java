...
public class EndV2FruitDecorator extends CocoaDecorator {
	public static final EndV2FruitDecorator INSTANCE = new EndV2FruitDecorator();
	public static com.mojang.serialization.Codec<EndV2FruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("end_v_2_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public EndV2FruitDecorator() {
		super(0.2f);
	}
