...
public class RedWoodForestLeaveDecorator extends LeaveVineDecorator {
	public static final RedWoodForestLeaveDecorator INSTANCE = new RedWoodForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("red_wood_forest_tree_leave_decorator");
